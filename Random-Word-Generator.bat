...
echo 1. Paused
echo 2. Slideshow
echo 3. Generate 1000 words to file
echo=
echo A. About script
echo=
echo 0. Exit
...
if /i "!userInput!" == "2" goto slideshowMode
if /i "!userInput!" == "3" goto writeMode
goto menu
...
timeout /t !displayWords! > nul
goto slideshowMode

:writeMode
cls
echo Word statistic data    : !statisticName!
echo=
echo [%time%] Generating words...
for /l %%n in (1,1,1000) do (
    title Random Artificial Word Generator - #%%n
    call :randword
    echo !word!
) >> "!statisticName!.txt"
echo [%time%] Done
